...
Route::get('/language/other', [LanguageController::class, 'Other'])->name('other.language');
...
// Add to Wishlist
Route::post('/add-to-wishlist/{product_id}', [CartController::class, 'AddToWishlist'])->name('add-to-wishlist');
...
//    Route::post('/post/store', [BlogController::class, 'BlogPostStore'])->name('post-store');
    ...
    Route::post('/post/update', [BlogController::class, 'BlogPostStore'])->name('blogpost.update');
