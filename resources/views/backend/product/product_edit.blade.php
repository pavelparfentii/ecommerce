                                                    ...
                                                    <div class="controls">
                                                        <select name="brand_id" class="form-control" required="">
                                                            ...
                                                            @foreach($brands as $brand)
                                                                <option
                                                                    value="{{ $brand->id }}" {{ $brand->id == $products->brand_id ? 'selected': '' }} >{{ $brand->brand_name }}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('brand_id')
                                                    ...
                                                    <div class="controls">
                                                        <select name="category_id" class="form-control" required="">
                                                            ...
                                                            @foreach($categories as $category)
                                                                <option
                                                                    value="{{ $category->id }}" {{ $category->id == $products->category_id ? 'selected': '' }} >{{ $category->category_name }}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('category_id')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    ...
                                                    <div class="controls">
                                                        <select name="subcategory_id"
                                                            ...
                                                            @foreach($subcategory as $sub)
                                                                <option
                                                                    value="{{ $sub->id }}" {{ $sub->id == $products->subcategory_id ? 'selected': '' }} >{{ $sub->subcategory_name }}</option>
                                                            @endforeach
                                                    ...
                                                    <div class="controls">
                                                        <select name="subsubcategory_id" class="form-control"
                                                            ...
                                                            @foreach($subsubcategory as $subsub)
                                                                <option
                                                                    value="{{ $subsub->id }}" {{ $subsub->id == $products->subsubcategory_id ? 'selected': '' }} >{{ $subsub->subsubcategory_name }}</option>
                                                            @endforeach
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="box bt-3 border-info">
                        ...
                        <form method="post"
                              action="{{ route('update-product-thumbnail') }}"
                              enctype="multipart/form-data">
                            @csrf
