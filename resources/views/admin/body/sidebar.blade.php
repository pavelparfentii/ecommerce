        ...
        <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="{{ ($route == 'confirmed-orders')? 'active':'' }}"><a
                                ...
                                <i class="ti-more"></i>Confirmed Orders</a>
                        </li>
                        ...
                        <li class="{{ ($route == 'picked-orders')? 'active':'' }}">
                            <a href="{{ route('picked-orders') }}">
                                <i class="ti-more"></i> Picked Orders</a>
                        </li>
            ...
            @if($alluser == true)
              ...
              <i class="fa fa-angle-right pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="{{ ($route == 'all-users')? 'active':'' }}"><a href="{{ route('all-users') }}">
                                <i
                                    class="ti-more">
                                </i>All Users</a>
                        </li>
