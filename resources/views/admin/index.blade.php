                        ...
                        <div class="box-body">
                            ...
                            <div>
                                ...
                                <h3 class="text-white mb-0 font-weight-500">${{ $today  }} <small
                                        class="text-success"><i class="fa fa-caret-up"></i> Usd</small></h3>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="box overflow-hidden pull-up">
                        <div class="box-body">
                            ...
                            <div>
                                ...
                                <h3 class="text-white mb-0 font-weight-500">${{ $year }} <small class="text-danger">
                        ...
                        <div class="box-body">
                            ...
                            <div>
                                ...
                                <h3 class="text-white mb-0 font-weight-500">{{ count($pending) }} <small
                                        class="text-danger">
                                        <i class="fa fa-caret-up"></i> Order </small>
                                </h3>
                            </div>
                        </div>
                    </div>
