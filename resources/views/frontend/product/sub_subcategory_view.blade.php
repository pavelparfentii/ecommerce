                ...
                <div class='col-md-9'>
                    ...
                    @foreach($breadsubsubcat as $item)
                        ...
                        <span class="badge badge-danger"
                              style="background: #808080">{{ $item->category->category_name }} </span>
                    ...
                    @foreach($breadsubsubcat as $item)
                        ...
                        <span class="badge badge-danger"
                              style="background: #808080">{{ $item->subcategory->subcategory_name }} </span>
                    @endforeach

                    @foreach($breadsubsubcat as $item)

                        <span class="badge badge-danger"
                              style="background: #FF0000">{{ $item->subsubcategory_name }} </span>
                    @endforeach
