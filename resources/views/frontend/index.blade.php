                                    ...
                                    <div class="products">
                                        <div class="product">
                                            ...
                                            <div class="product-info text-left">
                                                ...
                                                @else
                                                    <div class="product-price"><span
                                                            class="price"> ${{ $product->discount_price }} </span> <span
                                                            class="price-before-discount">$ {{ $product->selling_price }}</span>
                                                    </div>
                                                @endif
                                    ...
                                    <div class="item">
                                        <div class="blog-post">
                                            ...
                                            <div class="blog-post-info text-left">
                                                ...
                                                <p class="text">
                                                        {!! Str::limit($blog->post_details, 100 )  !!}
                                                </p>


                                                <a href="{{ route('post.details',$blog->id) }}"
                                                   class="lnk btn btn-primary">Read more</a></div>
                                            <!-- /.blog-post-info -->
